...
lm =dspy.LM(model=f"ollama_chat/{model_name }",api_key="" )
...
class DocumentationFetcher:
    ...
    def __init__(self, max_retries=3, delay=1):
        ...
        self.session.headers.update({
            'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64; Ubuntu; Pop_OS 22.04) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36'
        })
